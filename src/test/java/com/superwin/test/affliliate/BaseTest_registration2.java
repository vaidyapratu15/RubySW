...
import com.superwin.main.AffiliateCode;
...
public class BaseTest_registration2 extends BaseClass{
...
//     	driver.get(GetGsonTestData.getConfigData().getRegistration2());	
//		driver.get("https://superwin.co/user-registration");
		driver.get("https:/superwin.co/quick-signup4/?btag=new_casdg");
		ExtentSparkReporter sparkReporter_all = new ExtentSparkReporter("registration2.html");
		sparkReporter_all.config().setReportName("registration2 report");
	...
	public void generateExtentReports() throws Exception {
		extentReports.flush();
		Desktop.getDesktop().browse(new File("registration2.html").toURI());
	}
