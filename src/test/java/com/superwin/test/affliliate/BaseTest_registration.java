...
public class BaseTest_registration extends BaseClass{
	...
	public void initializeBrowser() throws IOException {
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
     	driver.get(GetGsonTestData.getConfigData().getRegistrationAffUrl());	
		ExtentSparkReporter sparkReporter_all = new ExtentSparkReporter("registration.html");
		sparkReporter_all.config().setReportName("registration");
	...
	public void generateExtentReports() throws Exception {
		extentReports.flush();
		Desktop.getDesktop().browse(new File("registration.html").toURI());
	}
