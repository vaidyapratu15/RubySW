...
public class AdminPanelReferralBonusSettingsTC extends Admin_BaseTest {
	...
	public void clickOnBonusSettings() {
		referralBonus.clickOnBonusSettings();
	}

	@Test(priority = 5)
	public void scrollTillPreReferralBonus() {
		referralBonus.scrollTillPreReferralBonus();
	}

	@Test(priority = 6)
	public void selectPreReferralBonusType() {
		referralBonus.selectPreReferralBonusType("Direct");
	}

	@Test(priority = 7)
	public void selectReferralBonusType() {
		referralBonus.selectReferralBonusType("Direct");
	}
